    ...
    with open(f,"r") as fh:
        ...
        for i in data:
            ...
            for i in range(posts//20+1):
                ...
                thread_count += 20
            with open(f"./Threads/{slug}.json","w",encoding="utf-8") as f:
